...
// we declare this manually instead of using `z.input<typeof ServerPluginContributions>` because
// the JSDoc gets lost in .d.ts files
/**
 * Components and behaviors contributed to the server side of Clarity by a plugin.
 */
export type ServerPluginContributions = () => {
...
export const ServerPluginContributions = z.function(
  z.tuple([]),
  z.object({
    api: z
      .function(
...
) satisfies z.ZodType<ServerPluginContributions, any, ServerPluginContributions>
