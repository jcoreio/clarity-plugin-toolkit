...
/**
 * The subset of {@link PoolClient pg.PoolClient}'s API that Clarity exposes to plugins.
...
/**
 * The subset of {@link Pool pg.Pool}'s API that Clarity exposes to plugins.
